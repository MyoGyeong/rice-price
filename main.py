...
if select_city == '서울':
    data = pd.read_csv("C:\\Users\\thsay\\PycharmProjects\\rice_price\\data\\seoul.csv")
elif select_city =='광주':
    data = pd.read_csv("C:\\Users\\thsay\\PycharmProjects\\rice_price\\data\\gwangju.csv")
elif select_city=='대구':
    data = pd.read_csv("C:\\Users\\thsay\\PycharmProjects\\rice_price\\data\\daegu.csv")
elif select_city=='대전':
    data = pd.read_csv("C:\\Users\\thsay\\PycharmProjects\\rice_price\\data\\daejeon.csv")
else :
    data = pd.read_csv("C:\\Users\\thsay\\PycharmProjects\\rice_price\\data\\busan.csv")
